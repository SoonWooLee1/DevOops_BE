...
public class ReportServiceImplTest {
    ...
    void setUp() {
        ...
        reportServiceImpl = new ReportServiceImpl(
                reportRepository, memberRepository, reportCategoryRepository,
    ...
    void testDuplicateOopsReport() {
        ...
        when(reportRepository.existsByOopsId(oops)).thenReturn(true);
    ...
    // =======================================================
    @Test
    @DisplayName("신고 처리 Y: Oops 게시글 Hard Delete 수행")
    void testUpdateReportStateToY_DeleteOops() {
        ...
        verify(oopsCommandRepository, times(1)).delete(oops);
        verify(reportRepository, times(1)).save(report);
    }

    // =======================================================
    @Test
    @DisplayName("이미 처리된 신고 상태는 변경 불가")
    void testUpdateAlreadyProcessed() {
        ReportEntity report = new ReportEntity();
        report.setId(2L);
        report.setState("Y");
        ...
        assertThrows(IllegalStateException.class,
                () -> reportServiceImpl.updateReportState(2L, "N"));
    ...
    // =======================================================
    @Test
    @DisplayName("댓글 신고 승인 시 댓글 Hard Delete 수행")
    void testUpdateReportStateToY_DeleteComment() {
        ReportEntity report = new ReportEntity();
        report.setId(3L);
        report.setState("U");
